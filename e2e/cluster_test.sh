...
E2E_COMPOSE_OVERLAYS="${E2E_COMPOSE_OVERLAYS:-} $E2E_ROOT/deploy/compose/docker-compose.kind.yml $E2E_ROOT/deploy/compose/docker-compose.serve-all.yml"
NS="axiom-e2e"
...
compose restart "$E2E_SVC_GATEWAY" >/dev/null 2>&1
